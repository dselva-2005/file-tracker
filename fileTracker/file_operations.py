...
def delete_file(file_path):
    ...
    if os.path.exists(file_path):
        os.remove(file_path)
        pass#print(f"File '{file_path}' deleted successfully!")
    else:
        pass#print(f"File '{file_path}' does not exist!")
...
def create_file(file_path):
    ...
    if os.path.exists(file_path):
        pass#print(f"File '{file_path}' already exists!")
    else:
        with open(file_path, 'w'):
            pass
        pass#print(f"File '{file_path}' created successfully!")
